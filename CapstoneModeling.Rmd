...
pacman::p_load(ggplot2, dplyr, skimr, caret, tidyverse, knitr, janitor, randomForest, gridExtra, corrplot, DMwR, pROC)
...
roc_plot_simple <- ggplot() +
  geom_line(aes(x = 1 - roc_curve_with_features$specificities, y = roc_curve_with_features$sensitivities), color = "blue") +
  geom_abline(linetype = "dashed", color = "gray") +
  labs(title = paste("Simple Model ROC (AUC =", round(auc(roc_curve_with_features), 3), ")"), x = "1 - Specificity", y = "Sensitivity") +
  theme_minimal()
